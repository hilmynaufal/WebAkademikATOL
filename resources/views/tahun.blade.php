...
<div class="col-md-12 p-5 pt-2">
   <h3><i class="fa fa-paperclip mr-2"></i>TAHUN PELAJARAN</h3><hr>
...
<table class="table table-bordered">
  <thead class="thead-dark">
    <tr>
      <th scope="col">No</th>
      <th scope="col">ID Tahun Pelajaran</th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>{{ $val->tahun_pelajaran}}</td>
          ...
          <td><a class="bg-warning p-2 text-white rounded edit-modal-click" data-id="{{ $val->id_tahun }}">EDIT</a></td>
         <td><a href="javascript:;" data-toggle="modal" onclick="deleteData('{{ $val->id_tahun }}')" data-target="#DeleteModal" class="bg-danger p-2 text-white rounded">DELETE</td>
            ...
            <form action="/tahun/tambah" method="post">
              @csrf
                <div class="form-group">
                  <label>ID Tahun Pelajaran</label>
          ...
          <div class="modal-body">
            <form action="/tahun/update" method="post">
              @csrf
                  <div class="form-group">
                  <label>ID Tahun Pelajaran</label>
                    <input type="text" name="id_tahun" class="form-control" id="edit-id_tahun">      
                  </div>

                 <div class="form-group">
                  <label>Tahun Pelajaran</label>
            <input type="text" name="tahun_pelajaran" class="form-control" id="edit-tahun_pelajaran">      
          </div>
          <div class="modal-footer">  
        <button type="submit" class="btn btn-success" data-dissmis="modal">Simpan</button>
        <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
...
<script type="text/javascript">
  $(document).on("click", ".edit-modal-click", function () {
    ...
    var nama = rowCells.eq(2).text();
     $("#edit-id_tahun").val(id);
     $("#edit-tahun_pelajaran").val(nama);
